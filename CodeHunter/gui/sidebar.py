...
class Sidebar(ctk.CTkFrame):
    ...
    def _build_logo(self):
        ...
        ctk.CTkLabel(logo_frame, text="CodeHunter",
            font=ctk.CTkFont(size=16, weight="bold"), text_color=C["text_primary"],
        ).pack(side="left")

        ctk.CTkLabel(self, text="v1.0  •  Python Analyzer",
    ...
    def _build_run_button(self):
        ...
        self.run_btn = ctk.CTkButton(self,
            ...
            fg_color=C["accent"], hover_color="#1F6FEB",
    ...
    def _build_navigation(self):
        ...
        for view_id, label in nav_items:
            btn = ctk.CTkButton(nav_frame, text=label,
                ...
                text_color=C["text_muted"], corner_radius=7,
